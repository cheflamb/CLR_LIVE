...
const { FiHeadphones, FiPlay, FiDownload, FiMail, FiGift, FiArrowRight, FiCheck, FiLoader } = FiIcons;
...
const Subscribe = () => {
  ...
  const platforms = [
    ...
    },
    {
      ...
      description: "Available on all Android devices"
    },
    {
      name: "YouTube",
      icon: FiPlay,
    ...
    },
    {
      ...
      description: "Listen directly on our platform"
    }
  ];
  ...
  const handleNewsletterSubmit = async (e) => {
    ...
    try {
      const { data, error } = await supabase
        ...
        .insert([
          {
            first_name: newsletterData.firstName,
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-brand-gold rounded-2xl p-8 text-center text-brand-black">
            ...
            <p className="text-xl mb-6 font-sans">
              Download our comprehensive guide with practical strategies, templates, 
              and checklists for building thriving kitchen teams.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-brand-gray mb-8 font-sans">
                Get exclusive insights, early access to episodes, and practical resources 
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-brand-black rounded-2xl p-8 text-white text-center"
        >
          <h2 className="text-3xl font-display font-bold mb-4">Listen to Latest Episodes</h2>
          ...
          <div className="bg-gray-800 rounded-xl p-6 max-w-2xl mx-auto">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div className="text-left">
                <h4 className="font-heading font-semibold">Building Resilient Kitchen Teams</h4>
